  ...
  window.onload = function () {
      ...
      let mainTask = ce("p", 'Ввод с клавиатуры непустого массива целых чисел, и вывод числа локальных максимумов (элемент является локальным максимумом, если он не имеет соседей, больших, чем он сам)', );
